#!/bin/bash
# 更新 Double Shot Latte 插件到最新版本（自动提交和推送）
# 用法: ./scripts/update-double-shot-latte.sh

set -e

PLUGIN_DIR="plugins/double-shot-latte"
UPSTREAM_URL="https://github.com/obra/double-shot-latte.git"

echo "☕ 正在更新 Double Shot Latte 插件..."
...
git commit -m "chore(double-shot-latte): 更新至 v$NEW_VERSION"
...
echo ""
echo "✅ Double Shot Latte 已成功更新至 v$NEW_VERSION 并推送到远程仓库！"
