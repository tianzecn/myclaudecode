#!/bin/bash
# 更新 Superpowers Lab 插件到最新版本（自动提交和推送）
# 用法: ./scripts/update-superpowers-lab.sh

set -e

PLUGIN_DIR="plugins/superpowers-lab"
UPSTREAM_URL="https://github.com/obra/superpowers-lab.git"

echo "🧪 正在更新 Superpowers Lab 插件..."
...
git commit -m "chore(superpowers-lab): 更新至 v$NEW_VERSION"
...
echo ""
echo "✅ Superpowers Lab 已成功更新至 v$NEW_VERSION 并推送到远程仓库！"
