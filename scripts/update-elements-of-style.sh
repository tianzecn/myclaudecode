#!/bin/bash
# 更新 The Elements of Style 插件到最新版本（自动提交和推送）
# 用法: ./scripts/update-elements-of-style.sh

set -e

PLUGIN_DIR="plugins/the-elements-of-style"
UPSTREAM_URL="https://github.com/obra/the-elements-of-style.git"

echo "📝 正在更新 The Elements of Style 插件..."
...
# 更新 marketplace.json 中的版本号（elements-of-style 是第 9 个插件）
...
git commit -m "chore(elements-of-style): 更新至 v$NEW_VERSION"
...
echo ""
echo "✅ The Elements of Style 已成功更新至 v$NEW_VERSION 并推送到远程仓库！"
