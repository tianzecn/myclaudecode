#!/bin/bash
# 更新 Episodic Memory 插件到最新版本（自动提交和推送）
# 用法: ./scripts/update-episodic-memory.sh

set -e

PLUGIN_DIR="plugins/episodic-memory"
UPSTREAM_URL="https://github.com/obra/episodic-memory.git"

echo "🧠 正在更新 Episodic Memory 插件..."
...
git commit -m "chore(episodic-memory): 更新至 v$NEW_VERSION"
...
echo ""
echo "✅ Episodic Memory 已成功更新至 v$NEW_VERSION 并推送到远程仓库！"
